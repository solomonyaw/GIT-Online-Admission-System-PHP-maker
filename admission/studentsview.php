...
fstudentsview.Lists["x_userlevel_id"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fstudentsview.Lists["x_userlevel_id"].Data = "<?php echo $students_view->userlevel_id->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($students->StudentID->Visible) { // StudentID ?>
	<tr id="r_StudentID">
		<td class="col-sm-2"><span id="elh_students_StudentID"><?php echo $students->StudentID->FldCaption() ?></span></td>
...
<?php echo $students->StudentID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->FirstName->Visible) { // FirstName ?>
	<tr id="r_FirstName">
		<td class="col-sm-2"><span id="elh_students_FirstName"><?php echo $students->FirstName->FldCaption() ?></span></td>
...
<?php echo $students->FirstName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->LastName->Visible) { // LastName ?>
	<tr id="r_LastName">
		<td class="col-sm-2"><span id="elh_students_LastName"><?php echo $students->LastName->FldCaption() ?></span></td>
...
<?php echo $students->LastName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->BithDate->Visible) { // BithDate ?>
	<tr id="r_BithDate">
		<td class="col-sm-2"><span id="elh_students_BithDate"><?php echo $students->BithDate->FldCaption() ?></span></td>
...
<?php echo $students->BithDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->Address->Visible) { // Address ?>
	<tr id="r_Address">
		<td class="col-sm-2"><span id="elh_students_Address"><?php echo $students->Address->FldCaption() ?></span></td>
...
<?php echo $students->Address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->Username->Visible) { // Username ?>
	<tr id="r_Username">
		<td class="col-sm-2"><span id="elh_students_Username"><?php echo $students->Username->FldCaption() ?></span></td>
...
<?php echo $students->Username->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->Password->Visible) { // Password ?>
	<tr id="r_Password">
		<td class="col-sm-2"><span id="elh_students_Password"><?php echo $students->Password->FldCaption() ?></span></td>
...
<?php echo $students->Password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->Country->Visible) { // Country ?>
	<tr id="r_Country">
		<td class="col-sm-2"><span id="elh_students_Country"><?php echo $students->Country->FldCaption() ?></span></td>
...
<?php echo $students->Country->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($students->photo->Visible) { // photo ?>
	<tr id="r_photo">
		<td class="col-sm-2"><span id="elh_students_photo"><?php echo $students->photo->FldCaption() ?></span></td>
		<td data-name="photo"<?php echo $students->photo->CellAttributes() ?>>
<span id="el_students_photo">
<span>
<?php echo ew_GetFileViewTag($students->photo, $students->photo->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($students->userlevel_id->Visible) { // userlevel_id ?>
	<tr id="r_userlevel_id">
		<td class="col-sm-2"><span id="elh_students_userlevel_id"><?php echo $students->userlevel_id->FldCaption() ?></span></td>
...
<?php echo $students->userlevel_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
