...
class cstudents_edit extends cstudents {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_StudentID")) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// BithDate
			$this->BithDate->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->BithDate->CurrentValue, 2), ew_CurrentDate(), $this->BithDate->ReadOnly);
...
fstudentsedit.Lists["x_userlevel_id"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fstudentsedit.Lists["x_userlevel_id"].Data = "<?php echo $students_edit->userlevel_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($students->StudentID->Visible) { // StudentID ?>
	<div id="r_StudentID" class="form-group">
		<label id="elh_students_StudentID" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->StudentID->FldCaption() ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->StudentID->CellAttributes() ?>>
<span id="el_students_StudentID">
<span<?php echo $students->StudentID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $students->StudentID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="students" data-field="x_StudentID" name="x_StudentID" id="x_StudentID" value="<?php echo ew_HtmlEncode($students->StudentID->CurrentValue) ?>">
<?php echo $students->StudentID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($students->FirstName->Visible) { // FirstName ?>
	<div id="r_FirstName" class="form-group">
		<label id="elh_students_FirstName" for="x_FirstName" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->FirstName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->FirstName->CellAttributes() ?>>
...
<?php if ($students->LastName->Visible) { // LastName ?>
	<div id="r_LastName" class="form-group">
		<label id="elh_students_LastName" for="x_LastName" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->LastName->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->LastName->CellAttributes() ?>>
...
<?php if ($students->BithDate->Visible) { // BithDate ?>
	<div id="r_BithDate" class="form-group">
		<label id="elh_students_BithDate" for="x_BithDate" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->BithDate->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->BithDate->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fstudentsedit", "x_BithDate", {"ignoreReadonly":true,"useCurrent":false,"format":2});
</script>
<?php } ?>
</span>
...
<?php if ($students->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group">
		<label id="elh_students_Address" for="x_Address" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->Address->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->Address->CellAttributes() ?>>
...
<?php if ($students->Username->Visible) { // Username ?>
	<div id="r_Username" class="form-group">
		<label id="elh_students_Username" for="x_Username" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->Username->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->Username->CellAttributes() ?>>
...
<?php if ($students->Password->Visible) { // Password ?>
	<div id="r_Password" class="form-group">
		<label id="elh_students_Password" for="x_Password" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->Password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->Password->CellAttributes() ?>>
...
<?php if ($students->Country->Visible) { // Country ?>
	<div id="r_Country" class="form-group">
		<label id="elh_students_Country" for="x_Country" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->Country->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->Country->CellAttributes() ?>>
...
<?php if ($students->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group">
		<label id="elh_students__Email" for="x__Email" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->_Email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($students->photo->Visible) { // photo ?>
	<div id="r_photo" class="form-group">
		<label id="elh_students_photo" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->photo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->photo->CellAttributes() ?>>
...
<?php if ($students->userlevel_id->Visible) { // userlevel_id ?>
	<div id="r_userlevel_id" class="form-group">
		<label id="elh_students_userlevel_id" for="x_userlevel_id" class="<?php echo $students_edit->LeftColumnClass ?>"><?php echo $students->userlevel_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $students_edit->RightColumnClass ?>"><div<?php echo $students->userlevel_id->CellAttributes() ?>>
