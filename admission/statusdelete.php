	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$sThisKey .= $row['admmision_status_id'];
				$conn->raiseErrorFn = $GLOBALS["EW_ERROR_FN"];
...
<?php if ($status->admmision_status_id->Visible) { // admmision_status_id ?>
		<th class="<?php echo $status->admmision_status_id->HeaderCellClass() ?>"><span id="elh_status_admmision_status_id" class="status_admmision_status_id"><?php echo $status->admmision_status_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($status->admmision_status->Visible) { // admmision_status ?>
		<th class="<?php echo $status->admmision_status->HeaderCellClass() ?>"><span id="elh_status_admmision_status" class="status_admmision_status"><?php echo $status->admmision_status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($status->admmision_status_id->Visible) { // admmision_status_id ?>
		<td<?php echo $status->admmision_status_id->CellAttributes() ?>>
<span id="el<?php echo $status_delete->RowCnt ?>_status_admmision_status_id" class="status_admmision_status_id">
...
<?php } ?>
<?php if ($status->admmision_status->Visible) { // admmision_status ?>
		<td<?php echo $status->admmision_status->CellAttributes() ?>>
<span id="el<?php echo $status_delete->RowCnt ?>_status_admmision_status" class="status_admmision_status">
