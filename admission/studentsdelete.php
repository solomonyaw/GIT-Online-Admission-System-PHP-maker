...
class cstudents_delete extends cstudents {
	...
	function Page_Main() {
		...
		if ($this->Recordset = ew_LoadRecordset($sql, $conn)) {
			...
			if (!$res) $this->Page_Terminate("studentslist.php"); // Return to list
		}
...
fstudentsdelete.Lists["x_userlevel_id"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fstudentsdelete.Lists["x_userlevel_id"].Data = "<?php echo $students_delete->userlevel_id->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php if ($students->StudentID->Visible) { // StudentID ?>
		<th class="<?php echo $students->StudentID->HeaderCellClass() ?>"><span id="elh_students_StudentID" class="students_StudentID"><?php echo $students->StudentID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->FirstName->Visible) { // FirstName ?>
		<th class="<?php echo $students->FirstName->HeaderCellClass() ?>"><span id="elh_students_FirstName" class="students_FirstName"><?php echo $students->FirstName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->LastName->Visible) { // LastName ?>
		<th class="<?php echo $students->LastName->HeaderCellClass() ?>"><span id="elh_students_LastName" class="students_LastName"><?php echo $students->LastName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->BithDate->Visible) { // BithDate ?>
		<th class="<?php echo $students->BithDate->HeaderCellClass() ?>"><span id="elh_students_BithDate" class="students_BithDate"><?php echo $students->BithDate->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->Address->Visible) { // Address ?>
		<th class="<?php echo $students->Address->HeaderCellClass() ?>"><span id="elh_students_Address" class="students_Address"><?php echo $students->Address->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->Username->Visible) { // Username ?>
		<th class="<?php echo $students->Username->HeaderCellClass() ?>"><span id="elh_students_Username" class="students_Username"><?php echo $students->Username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->Password->Visible) { // Password ?>
		<th class="<?php echo $students->Password->HeaderCellClass() ?>"><span id="elh_students_Password" class="students_Password"><?php echo $students->Password->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->Country->Visible) { // Country ?>
		<th class="<?php echo $students->Country->HeaderCellClass() ?>"><span id="elh_students_Country" class="students_Country"><?php echo $students->Country->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($students->photo->Visible) { // photo ?>
		<th class="<?php echo $students->photo->HeaderCellClass() ?>"><span id="elh_students_photo" class="students_photo"><?php echo $students->photo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($students->userlevel_id->Visible) { // userlevel_id ?>
		<th class="<?php echo $students->userlevel_id->HeaderCellClass() ?>"><span id="elh_students_userlevel_id" class="students_userlevel_id"><?php echo $students->userlevel_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $students_delete->RowCnt ?>_students_StudentID" class="students_StudentID">
...
<span id="el<?php echo $students_delete->RowCnt ?>_students_FirstName" class="students_FirstName">
...
<span id="el<?php echo $students_delete->RowCnt ?>_students_LastName" class="students_LastName">
...
<?php } ?>
<?php if ($students->BithDate->Visible) { // BithDate ?>
		<td<?php echo $students->BithDate->CellAttributes() ?>>
<span id="el<?php echo $students_delete->RowCnt ?>_students_BithDate" class="students_BithDate">
...
<?php } ?>
<?php if ($students->Address->Visible) { // Address ?>
		<td<?php echo $students->Address->CellAttributes() ?>>
<span id="el<?php echo $students_delete->RowCnt ?>_students_Address" class="students_Address">
...
<span id="el<?php echo $students_delete->RowCnt ?>_students_Username" class="students_Username">
...
<span id="el<?php echo $students_delete->RowCnt ?>_students_Password" class="students_Password">
...
<?php } ?>
<?php if ($students->Country->Visible) { // Country ?>
		<td<?php echo $students->Country->CellAttributes() ?>>
<span id="el<?php echo $students_delete->RowCnt ?>_students_Country" class="students_Country">
...
<?php } ?>
<?php if ($students->photo->Visible) { // photo ?>
		<td<?php echo $students->photo->CellAttributes() ?>>
<span id="el<?php echo $students_delete->RowCnt ?>_students_photo" class="students_photo">
<span>
...
<?php } ?>
<?php if ($students->userlevel_id->Visible) { // userlevel_id ?>
		<td<?php echo $students->userlevel_id->CellAttributes() ?>>
<span id="el<?php echo $students_delete->RowCnt ?>_students_userlevel_id" class="students_userlevel_id">
