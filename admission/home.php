...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'students'))
		$this->Page_Terminate("studentslist.php"); // Exit and go to default page
		...
		if ($Security->AllowList(CurrentProjectID() . 'application'))
			$this->Page_Terminate("applicationlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'programs'))
			$this->Page_Terminate("programslist.php");
