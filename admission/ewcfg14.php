...
define("EW_PROJECT_NAME", "admissionsystem", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{F31DB578-461D-4551-B52B-112914F68329}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'bZhUeAnjPuv95uv9', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/admissionsystem.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "admission", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`students`", TRUE);
define("EW_USER_NAME_FILTER", "(`Username` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`StudentID` = %u)", TRUE);
...
define("EW_SENDER_EMAIL", "adeklosolomon@gmail.com", TRUE); // Sender email address
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,png,pdf", TRUE); // Allowed file extensions
