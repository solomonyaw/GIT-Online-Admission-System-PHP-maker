...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>git.ico"><link rel="icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>git.ico">
...
<div class="wrapper ewLayout">
	...
	<header class="main-header">
		<div class="logo">
			...
			<a  style ="color:white"href="http://localhost/admission"><span class="logo-lg">GIT</span></a>
		</div>
		<!-- Header Navbar -->
